    ...
    <MainLayout>
      <div className="container-app py-6 md:py-8">
        ...
        <div className="grid lg:grid-cols-[280px_1fr] gap-6">
          ...
          <div>
            {/* Top Bar */}
            <div className="flex items-center justify-between gap-3 mb-6 sticky top-16  z-20 bg-[#FEFBF3]/95 backdrop-blur-md py-3 -mx-4 px-3 rounded-xl sticky top-[130px]  md:mx-0 shadow-sm border-b border-[#E9E1D2] md:border-0">
