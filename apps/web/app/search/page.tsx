    ...
    <MainLayout>
      <div className="container-app py-6 md:py-8">
        ...
        <div className="grid lg:grid-cols-[280px_1fr] gap-6">
          ...
          <div>
            {/* Top Bar */}
            <div className="flex items-center justify-between gap-3 mb-6 sticky top-16 md:top-20 z-20 bg-[#FEFBF3]/95 backdrop-blur-md py-3 -mx-4 px-4 md:mx-0 md:px-0 border-b border-[#E9E1D2] md:border-0">
