// apps/web/components/auth/onboarding/slide-trust.tsx
"use client";

import { motion } from "framer-motion";
import { ArrowRight, ArrowLeft, ShieldCheck } from "lucide-react";

interface SlideTrustProps {
  onNext: () => void;
  onBack: () => void;
  mode: "login" | "register";
}

export function SlideTrust({ onNext, onBack, mode }: SlideTrustProps) {
  return (
    <div
      className="relative flex h-full w-full flex-col"
      style={{
        backgroundImage: "url('/images/onboarding/welcome-trust.png')",
      ...
      <div className="relative z-10 mt-auto px-6 pb-16">
        ...
        >
          ...
          <p className="mt-3 text-[15px] leading-relaxed text-slate-600">
            Join 50,000+ users who trust Vitakart for authentic wellness.
          </p>
        </motion.div>
