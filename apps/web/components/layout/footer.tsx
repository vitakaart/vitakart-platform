...
// Uses inline SVG icons — no social media icons from lucide
      ...
      <div className="container-app py-12 md:py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            <Link href={ROUTES.HOME} className="flex items-center gap-2 mb-4">
              ...
              <span className="text-2xl font-bold text-white">Vitakart</span>
            </Link>
            <p className="text-sm text-gray-400 mb-4">
              Your trusted source for premium health & wellness products.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <FooterLink href={ROUTES.PRODUCTS}>All Products</FooterLink>
              <FooterLink href={ROUTES.CATEGORIES}>Categories</FooterLink>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <FooterLink href={ROUTES.SHIPPING}>Shipping Info</FooterLink>
              <FooterLink href={ROUTES.RETURNS}>Returns Policy</FooterLink>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li className="flex items-start gap-3">
                <MapPin className="w-5 h-5 flex-shrink-0 text-primary-400 mt-0.5" />
              ...
              <li className="flex items-center gap-3">
                ...
                <a href="mailto:hello@vitakart.com" className="hover:text-white transition-colors">
                  hello@vitakart.com
                </a>
              </li>
            </ul>
            ...
            <div className="mt-6">
              <p className="text-sm text-gray-400 mb-3">Subscribe to newsletter</p>
              <form className="flex gap-2">
                <input
                  type="email"
                  placeholder="Your email"
                  className="flex-1 bg-gray-800 text-white px-3 py-2 rounded-lg text-sm border border-gray-700 focus:border-primary-500 outline-none"
                />
                <button
                  type="submit"
        ...
        <div className="border-t border-gray-800 pt-8">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4 text-sm text-gray-400">
            <p>© {new Date().getFullYear()} Vitakart. All rights reserved.</p>
